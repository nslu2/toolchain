/*
 * include/asm-microblaze/checksum.h -- Checksum ops
 *
...
#ifndef __MICROBLAZE_CHECKSUM_H__
#define __MICROBLAZE_CHECKSUM_H__
...
/*	asm ("hsw %1, %0; add %1, %0" : "=&r" (result) : "r" (sum)); */
	...
	result = sum + ((sum >>16)& 0x0000FFFF) + ((sum << 16) & 0xFFFF0000);
...
#endif /* __MICROBLAZE_CHECKSUM_H__ */
